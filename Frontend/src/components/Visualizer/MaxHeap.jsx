  ...
  return (
    <div className="min-h-screen bg-black text-white p-8 ">
      ...
      <p className="text-sm text-center text-white/70 mb-6">
        Max Heap represented as a binary tree. Each parent is greater than its
        children.
      </p>
      ...
      <div className="flex justify-center items-start gap-12 mt-6 flex-wrap">
        ...
        {/* Right: Priority Queue and Top Value */}
